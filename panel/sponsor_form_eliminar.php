<?php
$titulo="Panel de Control - Eliminaci&oacute;n de Sponsor";
...
<html>
	...
	<body>
        ...
        $consulta="select * from gears where id = $id_param";
      ...
      <tr>
                ...
                <tr>
                    <td><a href="sponsor_eliminar.php?id=<?php echo($id_param); ?>">CONFIRMA LA ELIMINACION</a></td>
                </tr>
		    </table>                            
        <?php
        mysql_close();?>
