...
<html>
	...
	<body>
        ...
        $consulta="select MAX(id) from noticias"; // Obtiene el máximo índice de la tabla
...
/*        switch($error){
        ...
        ?>
        <form name="form_noticias" action="noticias_agregar.php" method="post">
            <table id="tabla_abm_noticia">
                ...
                <tr>
                    <th>Texto</th>
                    <td><textarea name="noticia" cols="60" rows="20" id="noticia"></textarea></td>
                </tr>
                <tr>
