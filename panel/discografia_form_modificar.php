...
<html>
	...
	<body>
        ...
        switch($error){
            ...
            case 3:
				{ ?>
					<script language="javascript" type="text/javascript"> alert('El archivo es demasiado grande. Tamaño Máximo 100KB'); return 0;</script>
                ...
                <tr>
                    ...
                    <td><?php if($fila[imagen]) 
                            ...
                            echo("Sin imagen para mostrar");
                             ?> <br>Si desea agregar/cambiar la imagen, seleccionela aquí abajo
