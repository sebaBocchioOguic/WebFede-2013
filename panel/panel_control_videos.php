<?php
$titulo="Panel de Control - VIDEOS";
...
<html>
	...
	<body>
        ...
        <table id="tabla_abm_noticia">
            ...
            <tr>
                <td><a href="videos_form_modificar.php?id=<?php echo($fila[id]); ?>">MODIFICAR</a></td>
                <td><a href="videos_form_eliminar.php?id=<?php echo($fila[id]); ?>">ELIMINAR</a></td>
            </tr>
        </table>
        <?php } //LOOP DEL WHILE 
        mysql_close();
        echo("Se han encontrado ".$cantidad." videos.");?>
        <br /><a href="videos_form_agregar.php">AGREGAR</a>
	</body>
</html>
