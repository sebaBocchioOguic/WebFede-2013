...
<html>
	...
	<body>
        ...
        $consulta="select MAX(id) from audio"; // Obtiene el máximo índice de la tabla
        ...
        switch($error){
			...
			case 2:
				{?>
				<script language="javascript" type="text/javascript"> alert('Debe ingresar algún archivo de música'); return 0;</script>
                <?php //echo("Debe ingresar alg&uacute;n archivo");
				break;}
			case 3:
                {?>
				<script language="javascript" type="text/javascript"> alert('El formato del archivo no es válido. Debe ser MP3 o WMA'); return 0;</script>
                <?php //echo("El formato del archivo no es v&aacute;lido. Debe ser MP3 o WMA");
                break;}
            case 4:
                {?>
				<script language="javascript" type="text/javascript"> alert('Ocurrió algún error al subir el fichero. No pudo guardarse.'); return 0;</script>
                <?php //echo("Ocurrió algún error al subir el fichero. No pudo guardarse.");
                break;}
        }
        ?>
