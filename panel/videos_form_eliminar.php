<?php
$titulo="Panel de Control - Eliminaci&oacute;n de Videos";
...
<html>
	...
	<body>
        ...
        ?>ESTA POR ELIMINAR EL SIGUIENTE ARCHIVO DE AUDIO
            <table id="tabla_abm_noticia">
                ...
                <tr>
                    <td><a href="videos_eliminar.php?id=<?php echo($fila[id]); ?>">CONFIRMA LA ELIMINACION</a></td>
                </tr>
		    </table>
        <?php
        mysql_close();?>
